# python3 linfa/plot_res.py --folder results/ --name TP15_no_disc_error_estimation_aiche --iter 6000 --picformat png
...
python3 plot_mcmc_and_linfa.py --folder results/ --name TP15_no_disc_error_estimation_aiche --iter 6000 --picformat png
