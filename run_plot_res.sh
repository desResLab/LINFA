python3 linfa/plot_res.py --folder results/ --name TP1_uniform_prior_no_disc --iter 25000 --picformat png
...
python3 linfa/plot_disc.py --folder results/ --name TP1_uniform_prior_no_disc --iter 25000 --picformat png --mode marginal_posterior --num_points 10 --limfactor 1.0 --saveinterval 1000
